...
docker run --name some-mysql -e MYSQL_ROOT_PASSWORD=<your-password> -d mysql:tag

docker run --name MySQL57 -p 3306:3306 -e MYSQL_ROOT_PASSWORD=<your-password> -d mysql:5.7
...
#### 实战版本
```shell
docker run -d -p 3306:3306 --privileged=true -v /tmp/mysql/log:/var/log/mysql -v /tmp/mysql/data:/var/lib/mysql -v /tmp/mysql/conf:/etc/mysql/conf.d -e MYSQL_ROOT_PASSWORD=<your-password> --name MySQL57Prod mysql:5.7
